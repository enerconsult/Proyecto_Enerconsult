# =============================================================================
#  ROBOT XM - VERSIÓN DE PRODUCCIÓN (FINAL)
#  Incluye: GUI, Descarga FTP, Auto-reparación, Reportes Multi-filtro
#  Corrección: BD y Reportes se guardan en la Ruta Local del usuario.
# =============================================================================
...
# =============================================================================
#  MÓDULO 2: BASE DE DATOS E INGESTA (CON CORRECCIÓN DE RUTA)
# =============================================================================
...
def proceso_base_datos(config, es_reintento=False):
    ...
    # --- CORRECCIÓN: BD EN LA RUTA LOCAL DEL USUARIO ---
...
# =============================================================================
#  MÓDULO 3: GENERACIÓN DE REPORTES (CON CORRECCIÓN DE RUTA)
# =============================================================================
...
def generar_reporte_logica(config):
    ...
    # --- CORRECCIÓN: Rutas relativas a la carpeta del usuario ---
