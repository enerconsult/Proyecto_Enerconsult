...
class ModuloVisualizador:
    def __init__(self, root):
        ...
        self.cb_valor_filtro1 = ttk.Combobox(frame_cfg, textvariable=self.var_valor_filtro1, state="readonly", width=25)
        self.cb_valor_filtro1.grid(row=1, column=3, padx=5)

        # FILA 2: Filtro Secundario (NUEVO)
        ...
        ttk.Label(frame_cfg, text="Valor Secundario:").grid(row=2, column=2, sticky="w", padx=10)
        self.cb_valor_filtro2 = ttk.Combobox(frame_cfg, textvariable=self.var_valor_filtro2, state="readonly", width=25)
    ...
    def al_seleccionar_tabla(self, event):
        ...
        # Llenamos ambas listas de filtros con los mismos candidatos
    ...
    def generar_grafico(self):
        ...
        try:
            ...
            # --- CONSTRUCCIÓN DINÁMICA DEL QUERY MULTI-FILTRO ---
            ...
            # Filtro 2 (Solo si se seleccionó algo)
