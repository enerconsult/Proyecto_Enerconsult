    ...
    def __init__(self, parent, title=None, icon=None, *args, **kwargs):
        ...
        if title or icon:
            ...
            if icon:
                ...
                lbl_icon.pack(side="left", padx=(0, 4), anchor="center")
...
class AplicacionXM:
    ...
    def configurar_estilos_modernos(self):
        ...
        style.configure("CardTitle.TLabel", font=("Segoe UI Semibold", 14), background=c_blanco, foreground=c_azul_corp)
        style.configure("CardIcon.TLabel", font=("Segoe UI Semibold", 15), foreground=c_azul_corp, background=c_blanco)
    ...
    def actualizar_dashboard(self):
        ...
        card_metrics = Card(col_metrics, title="Estado del Sistema", icon="🔎")
        ...
        def add_stat_row(parent, icon, title, value, color_val="#2c3e50"):
            ...
            tk.Label(row, text=icon, font=("Segoe UI", 12), bg="#ffffff").pack(side="left", padx=5)
            tk.Label(row, text=title, font=("Segoe UI Semibold", 10), bg="#ffffff", fg="#6b7280").pack(side="left")
        ...
        tk.Label(content_flow, text=guide_text, font=("Segoe UI", 10), bg="#ffffff", fg="#6b7280", justify="center").pack(pady=30)
