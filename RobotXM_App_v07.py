# =============================================================================
#  ROBOT XM - SUITE INTEGRADA (v11 - FINAL + PERSISTENCIA FECHAS VISUALIZADOR)
#  Funcionalidades:
#  1. Descarga FTP Automática y Autoreparación.
#  2. Base de Datos SQLite Incremental.
#  3. Reportes Excel (Números ok, Filtro Versión ok, Fechas ok).
#  4. VISUALIZADOR GRÁFICO (Con memoria de fechas y estilo mejorado).
#  5. LOGO CORPORATIVO.
# =============================================================================
...
class ModuloVisualizador:
    def __init__(self, parent_frame, config):
        ...
        # --- SECCIÓN FECHAS VISUALIZADOR (Con Persistencia) ---
        fr_fechas_viz = ttk.LabelFrame(frame_cfg, text="Rango de Fechas (Gráfico)")
        fr_fechas_viz.grid(row=5, column=0, columnspan=4, sticky="ew", pady=10)
        ...
        # Cargar fecha guardada o default
...
class AplicacionXM:
    def __init__(self, root):
        ...
        # --- PASAMOS LA CONFIG AL VISUALIZADOR PARA QUE LEA LAS FECHAS ---
    ...
    def get_config(self):
        return {
            ...
            # --- NUEVO: GUARDAR FECHAS DEL VISUALIZADOR ---
