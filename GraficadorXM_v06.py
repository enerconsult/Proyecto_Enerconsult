...
class ModuloVisualizador:
    def __init__(self, root):
        ...
        self.cb_valor_filtro1 = ttk.Combobox(frame_cfg, textvariable=self.var_valor_filtro1, width=25) # Quitamos 'readonly' para permitir borrar
        ...
        self.cb_valor_filtro2 = ttk.Combobox(frame_cfg, textvariable=self.var_valor_filtro2, width=25) # Quitamos 'readonly'
    ...
    def _cargar_valores_filtro(self, var_campo, widget_cb):
        ...
        try:
            ...
            # CAMBIO CLAVE: NO SELECCIONAR AUTOMÁTICAMENTE EL PRIMERO
            # Dejamos el campo vacío para que sea opcional
            widget_cb.set('') 
        except: pass
    ...
    def generar_grafico(self):
        ...
        try:
            ...
            # Filtro 1 (Solo aplica si valor1 tiene texto)
            if campo1 and valor1:
                query += f" AND CAST({campo1} AS TEXT) = '{valor1}'"
                
            # Filtro 2 (Solo aplica si valor2 tiene texto)
