...
class AplicacionXM:
    def __init__(self, root):
        ...
        self.txt_console = ScrolledText(console_container, height=6, state='disabled', bootstyle="success", font=('Consolas', 10))
    ...
    def crear_tab_filtros(self):
        ...
        # self.cb_r_ver.bind("<<ComboboxSelected>>", self.actualizar_todas_versiones_filtro) # DESHABILITADO: Evitar sobrescribir filas
