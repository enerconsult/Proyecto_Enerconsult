...
class CustomDropdownWithTooltip:
    def __init__(self, master, textvariable=None, width=18):
        self.master = master
        self.items = []
        ...
        self.entry.bind("<KeyRelease>", self.filter_items) # Opcional: filtrado básico al escribir
    ...
    def filter_items(self, event):
        # Implementación simple de búsqueda si el usuario escribe
        pass
...
class ModuloVisualizador:
    ...
    def al_seleccionar_tabla(self, event):
        ...
        self.cb_campo_filtro1.set(''); self.var_valor_filtro1.set('')
        self.cb_campo_filtro2.set(''); self.var_valor_filtro2.set('')
