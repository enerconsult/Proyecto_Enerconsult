# =============================================================================
#  ROBOT XM - SUITE INTEGRADA (v12 - FINAL + TIPOS DE GRÁFICO Y COLORES)
#  Funcionalidades:
#  1. Descarga FTP Automática.
#  2. Base de Datos SQLite.
#  3. Reportes Excel.
#  4. VISUALIZADOR AVANZADO (Líneas, Barras, Áreas + Colores).
#  5. Logo Corporativo.
# =============================================================================
...
# COLORES CORPORATIVOS Y ESTÁNDAR
COLORES_GRAFICO = {
    "Verde Corporativo": "#8cc63f", # Aproximado al logo
    "Azul Corporativo": "#0093d0",  # Aproximado al logo
    "Rojo Intenso": "#e74c3c",
    "Naranja": "#f39c12",
    "Morado": "#9b59b6",
    "Gris Oscuro": "#34495e",
...
class ModuloVisualizador:
    def __init__(self, parent_frame, config):
        ...
        # --- NUEVAS VARIABLES PARA TIPO Y COLOR ---
        ...
        # Fila 4: Operación y Tipo Gráfico
        ...
        # Botón
        ttk.Button(frame_cfg, text="📊 GENERAR GRÁFICO", command=self.generar_grafico).grid(row=7, column=0, columnspan=4, pady=10, sticky="ew")
    ...
    def generar_grafico(self):
        ...
        try:
            ...
            self.dibujar_plot(serie_graficar.sort_index(), titulo_grafico, tipo_grafico, color_hex)
    ...
    def dibujar_plot(self, serie, titulo, tipo, color):
        ...
        # --- LÍNEA FANTASMA PARA TOOLTIPS (Truco para que funcione en Barras/Área) ---
        ...
        def update_annot(ind):
            x, y = line_ghost.get_data() # Usamos la línea fantasma como referencia
            idx = ind["ind"][0]
            val_x = x[idx]
